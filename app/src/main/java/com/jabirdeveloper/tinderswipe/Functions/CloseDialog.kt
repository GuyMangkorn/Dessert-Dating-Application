...
class CloseDialog(private var context: Context,private var currentUid:String) {
    fun show(): Boolean {
        var b = false
        val mBuilder = AlertDialog.Builder(context)
            ...
            mBuilder.setPositiveButton(R.string.ok) { _, _ -> Close(currentUid,context).delete();  b=true}
